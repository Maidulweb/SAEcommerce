...
class BlogDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function($query){
            $edit = '<a href="'.route('admin.blog.edit',$query->id).'"><i class="far fa-edit"></i></a>';
            $delete = '<a class="delete-item" href="'.route('admin.blog.destroy', $query->id).'"><i class="far fa-trash-alt"></i></a>';
            return $edit.$delete;
          })
          ...
          ->addColumn('image', function($query){
            return '<img src="'.asset($query->image).'" alt="">';
          })
