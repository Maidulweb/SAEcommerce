...
class BrandDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function($query){
            $edit = '<a href="'.route('admin.brand.edit', $query->id).'"><i class="far fa-edit"></i></a>';
            $delete = '<a class="delete-item" href="'.route('admin.brand.destroy', $query->id).'"><i class="far fa-trash-alt"></i></a>';

            return $edit.$delete;
          })
          ->addColumn('logo', function($query){
            return $img = '<img src="'.asset($query->logo).'" alt="Nai"></img>';
        })
