...
class FooterSocialDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function($query){
            $edit = '<a href="'.route('admin.footer-social.edit', $query->id).'"><i class="far fa-edit"></i></a>';
            $delete = '<a class="delete-item" href="'.route('admin.footer-social.destroy', $query->id).'"><i class="far fa-trash-alt"></i></a>';
