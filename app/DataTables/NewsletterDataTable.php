...
class NewsletterDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function($query){
            $delete = '<a class="delete-item" href="'.route('admin.newsletter-subscriber.destroy', $query->id).'"><i class="far fa-trash-alt"></i></a>';

            return $delete;
          })
        ->addColumn('is_verified', function($query){
           return $query->is_verified == 1 ? '<i class="badge badge-success">Verified</i>' : '<i class="badge badge-danger">No Verified</i>';
        })
