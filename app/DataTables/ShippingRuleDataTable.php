    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function($query){
                $edit = '<a href="'.route('admin.shipping-rule.edit', $query->id).'"><i class="far fa-edit"></i></a>';
                $delete = '<a class="delete-item" href="'.route('admin.shipping-rule.destroy', $query->id).'"><i class="far fa-trash-alt"></i></a>';
                return $edit.$delete;
            })
            ...
            ->rawColumns(['action', 'status','min_cost'])
            ->setRowId('id');
    }
