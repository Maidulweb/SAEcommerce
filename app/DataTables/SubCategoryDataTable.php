    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function($query){
               $edit = '<a href="'.route('admin.sub-category.edit', $query->id).'">Edit</a>';
               $delete = '<a class="delete-item" href="'.route('admin.sub-category.destroy', $query->id).'"><i class="far fa-trash-alt"></i></a>';
               return $edit.$delete;
            })
