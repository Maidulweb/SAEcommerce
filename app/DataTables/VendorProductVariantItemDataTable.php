...
class VendorProductVariantItemDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function($query){
            $edit = '<a href="'.route('vendor.product-variant-item.edit', $query->id).'"><i class="far fa fa-edit"></i></a>';
            $delete = '<a class="delete-item" href="'.route('vendor.product-variant-item.delete', $query->id).'"><i class="far fa fa-trash-alt"></i></a>';
