    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function($query){
                $edit = '<a href="'.route('admin.withdraw.edit', $query->id).'"><i class="far fa fa-edit"></i></a>';
                $delete = '<a class="delete-item" href="'.route('admin.withdraw.destroy', $query->id).'"><i class="far fa fa-trash-alt"></i></a>';
            ...
            ->rawColumns(['action','charge','description'])
            ->setRowId('id');
    }
