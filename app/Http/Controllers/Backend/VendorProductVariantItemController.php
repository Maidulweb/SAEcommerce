...
class VendorProductVariantItemController extends Controller
{
    ...
    public function store(Request $request){
        ...
        return redirect()->route('vendor.product-variant-item.index',['productId'=>$request->product_id,'variantId'=>$request->variant_id])->with($response);
    }

    public function edit($variantId){
        $variant = ProductVariantItem::findOrFail($variantId);
        return view('vendor.product.product-variant-item.edit', compact('variant'));
    }
    ...
    public function update(Request $request,$id){
        ...
        return redirect()->route('vendor.product-variant-item.index',['productId'=>$productVariantItem->productVariant->product_id,'variantId'=>$productVariantItem->product_variant_id])->with($response);
    }
