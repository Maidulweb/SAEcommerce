                ...
                <div class="row">
                            ...
                            <div class="exzoom hidden" id="exzoom">
                                <div class="exzoom_img_box">
                                    ...
                                    <ul class='exzoom_img_ul'>
                                        ...
                                        <li><img class="zoom ing-fluid w-100" src="{{asset($image->images)}}" alt="product"></li>
                                        @endforeach
                                    </ul>
                                </div>
                    ...
                    <div class="col-xl-5 col-md-7 col-lg-7">
                        <div class="wsus__pro_details_text">
                            ...
                            <p class="brand_model"><span>logo :</span> <img src="{{asset($product->brand->logo)}}" alt=""></p>
                            ...
                            <div class="wsus__det_sidebar_banner">
                                ...
                                <div class="wsus__det_sidebar_banner_text_overlay">
                                    <div class="wsus__det_sidebar_banner_text">
                                        ...
                                        @if (checkOffer($product))
                                        <h4>Up To {{checkDiscountPercentage($product->price, $product->offer_price)}}% Off</h4>
                                        @endif
                ...
                <div class="col-xl-3 col-sm-6 col-lg-4">
                    <div class="wsus__product_item">
                        ...
                        <div class="wsus__product_details">
                            ...
                            <a class="wsus__pro_name" href="#">men's casual fashion watch</a>
                            <p class="wsus__price">{{$setting->currency_icon}}159 <del>{{$setting->currency_icon}}200</del></p>
                            <a class="add_cart" href="#">add to cart</a>
                        </div>
                    </div>
                </div>
