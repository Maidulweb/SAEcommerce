...
Route::get('get-messages', [VendorMessengerController::class, 'getMessages'])->name('get-messages');
Route::post('send-messages', [VendorMessengerController::class, 'sendMessage'])->name('send-message');